...
public class Home {
    ...
    private void displayUpcomingAppointments() {
        ...
        if (upcomingAppointments.isEmpty()) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/upcomingAppointments.fxml"));
    ...
    /**
     * Changes various controls' actions depending on selectedTab which should be customersTab or appointmentsTab.
     ...
     * @oaram appointmentId The appointment ID of an appointment to be modified or null if a new appointment is to be added.
     */
     ...
     * @oaram customerId The customer ID of a customer to be modified or null if a new customer is to be added.
     */
    ...
    public void generateReport() {
        ...
        if (monthTypeReportRb.isSelected()) {
            title = "Appointment Counts By Month and Type";
            ...
            if (contactReportSelector.getValue() != null) {
                ...
                title = "Contact/Customer Interaction";
                reportsDisplay.getChildren().add(reportTitle);
